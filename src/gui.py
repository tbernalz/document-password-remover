...
def main():
    ...
    def select_output_file():
        output_file = filedialog.asksaveasfilename(title="Save Decrypted PDF As", defaultextension=".pdf")
    ...
    def decrypt_pdf():
        ...
        if not input_pdf or not output_pdf or not password:
            messagebox.showerror("Error", "All fields (Input Path, Output Path, and Password) must be provided.")
            return
